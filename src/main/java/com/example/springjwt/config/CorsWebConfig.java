...
// 1. 보안 필터 외부에서의 요청 처리: Spring Security의 CORS 설정은 보안 필터 체인 내에서 처리되는 요청에만 적용됩니다. 그러나 일부 요청이 Spring Security의 보안 필터 체인을 우회하거나 필터 체인 외부에서 직접 처리되는 경우, 보안 설정이 적용되지 않을 수 있습니다.
// 예를 들어, 요청이 DispatcherServlet에서 직접 처리되는 경우가 이에 해당할 수 있습니다.
